...
namespace sexOSKernel.Commands
{
    ...
    public class CommandManager
    {
        ...
        public CommandManager()//constructorul pentru comenzi
        {
            ...
            this.commands.Add(new Sing("sing", "Plays a song"));
            ...
            this.commands.Add(new gameOfLife("life", "Starts Conway's Game Of Life Simulation - Press r for random or Enter for preset patterns!"));
